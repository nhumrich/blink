...
const embedded_std_net: Str = #embed("../lib/std/net.pact")
const embedded_std_net_error: Str = #embed("../lib/std/net_error.pact")
const embedded_std_net_tcp: Str = #embed("../lib/std/net_tcp.pact")
...
fn init_embedded_stdlib() {
    ...
    embedded_stdlib.set("net", embedded_std_net)
    embedded_stdlib.set("net_error", embedded_std_net_error)
    embedded_stdlib.set("net_tcp", embedded_std_net_tcp)
    ...
    embedded_stdlib.set("map", embedded_std_map)
