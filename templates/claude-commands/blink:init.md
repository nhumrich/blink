...
2. Use `Glob **/*.bl` to find all Blink source files.
3. Read the main entry point (usually `src/main.bl`).
4. Identify key patterns: effects used, modules imported, structs/enums defined.

If this is a brand new project (no .bl files yet), skip this step.
